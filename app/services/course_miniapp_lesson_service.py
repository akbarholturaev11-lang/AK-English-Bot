...
_QUIZ_TEXT = {
    "uz": {
        ...
        "hanzi_to_pinyin": "“{zh}” talaffuzi qanday?",
        ...
        "build_sentence_chips": "Inglizcha gapni tuzing",
    ...
    "ru": {
        ...
        "hanzi_to_pinyin": "Как произносится “{zh}”?",
        ...
        "build_sentence_chips": "Соберите английское предложение",
    ...
    "tj": {
        ...
        "hanzi_to_pinyin": "Талаффузи “{zh}” чӣ гуна аст?",
        ...
        "build_sentence_chips": "Ҷумлаи англисиро созед",
...
class CourseMiniAppLessonService:
    ...
    def _pilot_experience(self, *, lesson: CourseLesson, lang: str, title: str) -> dict:
        ...
        return {
            ...
            "variant": variant,
            "skeleton": [
                copy.get("start", "Boshlash"),
                copy.get("learn", "O'rganish"),
                copy.get("practice", "Mashq"),
                copy.get("explain", "AI izoh"),
                copy.get("win", "Natija"),
                copy.get("next", "Keyingi"),
            ],
            ...
            if len(chinese_tokens) >= 2:
                tasks.insert(
                    0,
                    {
                        ...
                        "prompt": {
                            "uz": f"Inglizcha gapni tuzing: {translated_sentence}",
                            "ru": f"Соберите английское предложение: {translated_sentence}",
                            "tj": f"Ҷумлаи англисиро созед: {translated_sentence}",
                        }.get(lang, f"Inglizcha gapni tuzing: {translated_sentence}"),
