    ...
    def _copy(lang: str, key: str) -> str:
        copy = {
            "ru": {
                ...
                "pinyin_choice": "Выберите правильное произношение",
                "hanzi_choice": "Выберите слово",
                "gap_fill": "Заполните пропуск",
                "character_recognition": "Узнайте слово",
                ...
                "pronunciation_question": "произношение?",
            },
            "tj": {
                ...
                "hanzi_choice": "Калимаро интихоб кунед",
                "gap_fill": "Ҷои холиро пур кунед",
                "character_recognition": "Калимаро шиносед",
                ...
                "pronunciation_question": "талаффуз?",
            },
            "uz": {
                "active_word": "Yangi faol so'z",
                "meaning_guess": "To'g'ri ma'noni tanlang",
                "listening_choice": "Tinglang va javobni tanlang",
                "pinyin_choice": "To'g'ri talaffuzni tanlang",
                "hanzi_choice": "To'g'ri so'zni tanlang",
                "gap_fill": "Bo'sh joyni to'ldiring",
                "character_recognition": "So'zni taning",
                ...
                "pronunciation_question": "talaffuzi?",
            },
        }
        ...
        for index, word in enumerate(focus_words[:6], 1):
            ...
            if pinyin:
                add_choice_activity(
                    ...
                    word=word,
                    option_key="pinyin",
                    prompt=f"{zh} — {self._copy(lang, 'pronunciation_question')}",
                    answer=pinyin,
