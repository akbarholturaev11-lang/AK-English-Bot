...
def level_keyboard(lang: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="Beginner", callback_data="level:hsk1"),
                InlineKeyboardButton(text="Elementary", callback_data="level:hsk2"),
            ],
            [
                InlineKeyboardButton(text="Intermediate", callback_data="level:hsk3"),
                InlineKeyboardButton(text="Advanced", callback_data="level:hsk4"),
            ],
        ]
    )
