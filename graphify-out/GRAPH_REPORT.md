...
## Corpus Check
- 315 files · ~574,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2933 nodes · 7442 edges · 77 communities detected
- Extraction: 54% EXTRACTED · 46% INFERRED · 0% AMBIGUOUS · INFERRED: 3459 edges (avg confidence: 0.72)
...
- `file_id ni yangilaydi yoki yaratadi (upsert).` --uses--> `CourseAudio`  [INFERRED]
...
- `Kamida bitta audio yuklangan darslar soni.` --uses--> `CourseAudio`  [INFERRED]
  app/repositories/course_audio_repo.py → /Users/kaijimima1234/Desktop/telegram_chinese_bot_clean/app/db/models/course_audio.py
- `course_reminder_timezone_keyboard()` --calls--> `handle_text_message()`  [INFERRED]
  /Users/kaijimima1234/Desktop/telegram_chinese_bot_clean/app/bot/keyboards/course.py → app/bot/handlers/messages.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (203): admin_deleteuser_handler(), bc_confirm(), bc_receive_text(), _discount_notify_keyboard(), _notify_discount_users(), admin_payment_approve_handler(), admin_payment_reject_handler(), admin_payment_reject_with_reason_handler() (+195 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (276): build_graph(), Graph, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff(), _is_concept_node() (+268 more)
...
Cohesion: 0.02
Nodes (111): add(), CacheManager, createProcessor(), DataProcessor, Get-Data(), GraphifyDemo, IProcessor, Loggable (+103 more)
...
Cohesion: 0.03
Nodes (58): MyApp.Accounts.User, create(), validate(), Server, _answer_course_tutor_question(), _ensure_ai_available(), _format_homework_evaluation_result(), _format_static_exercise_result() (+50 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (72): _background_scheduler(), lifespan(), Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., _seed_lessons(), Base (+64 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (144): find(), collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., _prepare_title_i18n(), _status_label(), course_go_dialogue(), course_go_exercise() (+136 more)
...
Cohesion: 0.05
Nodes (91): admin_audio_list_handler(), admin_back_keyboard(), admin_broadcast_handler(), admin_broadcast_info(), admin_channel_add_callback(), admin_channel_add_message(), admin_channel_delete_callback(), admin_channel_toggle_callback() (+83 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (69): admin_discount_panel(), _admin_ids(), _delete_admin_input(), discount_cancel(), discount_confirm(), discount_custom_duration(), discount_disable(), discount_duration() (+61 more)
...
Cohesion: 0.06
Nodes (27): admin_payment_reject_reason_select_handler(), admin_feedback_reply_cancel(), admin_feedback_reply_non_text_handler(), admin_feedback_reply_start(), _edit_message(), _edit_stored_message(), _extract_dislike_detail(), feedback_callback_handler() (+19 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (60): gemini_install(), gemini_uninstall(), Copy skill file to ~/.gemini/skills/graphify/, write GEMINI.md section, and inst, Remove the graphify section from GEMINI.md, uninstall hook, and remove skill fil, _agents_install(), _agents_uninstall(), _install(), Tests for graphify install --platform routing. (+52 more)
...
Cohesion: 0.06
Nodes (18): BaseMiddleware, create_bot(), main(), OnboardingStates, _get_demo_lesson(), process_level(), Returns (display_text, ai_context) tuple., Returns (display_text, ai_context) tuple. (+10 more)
...
Cohesion: 0.1
Nodes (30): AdminAudioStates, admin_audio_entry(), admin_audio_from_panel(), _after_upload_keyboard(), ask_for_audio_file(), audio_stats(), _audio_types_for_lesson(), _audio_types_keyboard() (+22 more)
...
- **Thin community `Community 49`** (4 nodes): `Transformer`, `.forward()`, `.__init__()`, `sample.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (3 nodes): `__getattr__()`, `graphify - extract · build · cluster · analyze · report.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `V2 vocab_1 / vocab_2 step: [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `V2 dialogue_N step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `Keyingi o'qish vaqtini tanlash — inline tugmalar (ReplyKeyboard o'rniga).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `V2 vocab_1 / vocab_2 step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `V2 dialogue_N step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `Keyingi o'qish vaqtini tanlash — inline tugmalar (ReplyKeyboard o'rniga).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 87`** (1 nodes): `Universal dispatcher: har qanday step nomi uchun formatlangan matn qaytaradi.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Bitta so'z blokini lines ga qo'shadi (V2 style HTML).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `V2: birinchi 8 ta so'z (vocab_1 step).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `V2: 9+ so'zlar (vocab_2 step). Bo'sh bo'lsa, bo'sh string qaytaradi.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `V2: n-chi dialog bloki (1-indexed), grammar_notes inline qo'yilgan.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `V2: grammatika — step raqamisiz, toza ko'rinish.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `Universal dispatcher: har qanday step nomi uchun formatlangan matn qaytaradi.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `Universal dispatcher: har qanday step nomi uchun formatlangan matn qaytaradi.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `lesson.title oddiy string yoki JSON bo'lishi mumkin — xitoycha qismini qaytaradi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `V2 vocab_1 / vocab_2 step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `V2 dialogue_N step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `Keyingi o'qish vaqtini tanlash — inline tugmalar (ReplyKeyboard o'rniga).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `t()` connect `Community 0` to `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 14`, `Community 18`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `Community 0` to `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 18`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 24`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Are the 179 inferred relationships involving `UserRepository` (e.g. with `User` and `Message`) actually correct?**
  _`UserRepository` has 179 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 134 inferred relationships involving `t()` (e.g. with `course_review_offer_keyboard()` and `course_satisfaction_keyboard()`) actually correct?**
